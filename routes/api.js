...
try {
var zahirr = db.get("Ivan-MLN");
} catch (e) {
	console.log('')
}

var creatorList = ['Ivan-MLN'];
...
loghandler = {
    notparam: {
        ...
        getApikey: 'Klo Butuh Apikey, Chat : https://wa.me/6285865781508'
    },
    notkey: {
        status: false,
        creator: `${creator}`,
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------Loli'+'IvanGanss';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'IvanGanss') return res.json(loghandler.invalidKey)
...
router.get('/tiktod', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)
	if(apikeyInput != 'IvanGanss') return res.json(loghandler.invalidKey)
